...
<head>
	...
	<title>XDI Connect Button Builder</title>
		...
		function clickbuildmessagexdiandhtml(url) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					text += '<input type="image" src="' + 'images/logo.png">\n';
...
<body>
	...
	<div id="header">
		...
		<span id="appname">XDI Connect Button Builder</span>
		</td>
		</tr>
		</table>
	...
	<h1>Step 5: Install and integrate the XDI Connect SDK with your Website</h1>

		<div class="step">

		<p>See XDI Connect SDK on Github</p>

		<p><a href="https://github.com/projectdanube/xdi2-connect-sdk">https://github.com/projectdanube/xdi2-connect-sdk</a></p>
